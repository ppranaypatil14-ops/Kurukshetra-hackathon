...
export default function HeroSection() {
  return (
    <main className="relative min-h-[calc(100vh-120px)] hero-glow flex items-center overflow-hidden">
      {/* BEGIN: Decorative Mosaic Background */}
      {/* Mosaic Grid Right Edge */}
      <div className="absolute right-0 top-12 bottom-0 pointer-events-none hidden xl:grid grid-cols-4 grid-rows-12 gap-0 z-0 opacity-90">
      ...
      <div className="absolute bottom-0 left-0 pointer-events-none hidden lg:flex items-end z-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <section className="lg:col-span-6 xl:col-span-6 max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <a
                className="inline-flex items-center justify-center bg-white text-black font-extrabold text-[15px] px-8 py-3.5 rounded-full hover:bg-neutral-100 hover:shadow-lg hover:shadow-white/10 active:scale-95 transition-all"
                href="#scan"
              >
          ...
          <section className="lg:col-span-6 xl:col-span-6 relative w-full max-w-xl mx-auto lg:ml-auto">
            <GaugeCard score={72} />
            <SecurityFindings />
          </section>
        </div>
