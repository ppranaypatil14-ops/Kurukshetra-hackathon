...
export default function ProofPointsSection() {
  return (
    <section className="w-full bg-[#ede8df] text-[#16131c] py-20 lg:py-24 px-4 sm:px-8 lg:px-12 border-t border-neutral-300/80 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-3.5">
              ...
              <div className="hidden sm:block"></div>
              <div className="bg-[#16131c] text-white p-5 sm:p-6 rounded-lg flex flex-col justify-between min-h-[140px] sm:min-h-[150px] shadow-sm">
              ...
              <div className="bg-gradient-to-br from-[#ff2a85] via-[#e11d74] to-[#c026d3] rounded-lg min-h-[140px] sm:min-h-[150px] shadow-sm"></div>
              ...
              <div className="col-span-2 bg-[#ff2a85] text-white p-5 sm:p-6 rounded-lg flex flex-col justify-between min-h-[140px] sm:min-h-[150px] shadow-sm">
              ...
              <div className="bg-gradient-to-tr from-[#e11d74] to-[#ff2a85] rounded-lg min-h-[140px] sm:min-h-[150px] shadow-sm"></div>
              <div className="bg-[#ffd000] text-[#16131c] p-4 sm:p-5 rounded-lg flex flex-col justify-between min-h-[140px] sm:min-h-[150px] shadow-sm">
              ...
              <div className="bg-[#ff2a85] text-white p-5 sm:p-6 rounded-lg flex flex-col justify-between min-h-[140px] sm:min-h-[150px] shadow-sm">
                <div className="text-xs sm:text-[13px] font-bold text-white/90 leading-snug">
              ...
              <div className="bg-[#ffd000] text-[#16131c] p-4 sm:p-5 rounded-lg flex flex-col justify-between min-h-[140px] sm:min-h-[150px] shadow-sm">
                ...
                <div className="space-y-2 mt-auto">
                  <div className="font-extrabold text-sm sm:text-base tracking-tight leading-none flex items-center gap-1.5">
                    <span className="w-3 h-3 bg-neutral-900 rounded-xs inline-block"></span>Replit
                  </div>
